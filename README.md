...
2. Fill in the subnet mask and the required host.
3. Press submit to see the results.
4. Press clear to make sure that the variables are cleared off and avoid stacking the previous results with the current.
